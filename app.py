...
# Chemin de la base de données locale (fichiers Excel)
data_dir = 'data/'
...
# Fonction pour convertir SMILES en PDB
...
# Fonction pour générer les liens de téléchargement des fichiers PDB
...
# Formulaire pour convertir SMILES en PDB
...
# Route pour solid cancer
@app.route('/solid_cancer')
def solid_cancer():
    return render_template('solid_cancer.html')

# Route pour afficher les informations d'un type de cancer
...
# Route pour convertir SMILES en PDB
...
# Route pour télécharger les fichiers PDB
